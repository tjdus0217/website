...
<div class="form-group">
	...
	<div class="col-sm-4">
	<input type="file" class="form-control" id="fname" name="fname" accept=".jpg, .png, .gif">
	</div>
</div>
...
<div class="form-group">
	...
	<button type="button" class="btn btn-default col-sm-1.3"    
	 		onclick="idCheck(document.frm.id.value)">ID Check</button>
	 		<div id="idcheck"></div>
...
<div class="form-group">
	<label class="control-label col-sm-2" for="repasswd"><span id="need">*</span>Re-Password</label>
	<div class="col-sm-4">
	<input type="password" class="form-control" id="repasswd" placeholder="Enter 비밀번호 확인" name="repasswd" >
	</div>
</div>
...
<div class="form-group">
	<label class="control-label col-sm-2" for="email"><span id="need">*</span>E-mail: </label>
	<div class="col-sm-4">
	<input type="email" class="form-control" id="email" 
	 ...
	 <button type="button" class="btn btn-default col-sm-1.3"    
	 			onclick="emailCheck(document.frm.email.value)">E-mail Check</button>
...
<div class="form-group">
	...
	<button type="button" class=" col-sm-offset-2 btn btn-default col-sm-1.3"    
