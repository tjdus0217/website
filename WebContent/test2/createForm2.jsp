...
<h1 class="col-sm-offset-2 col-sm-10">글등록</h1>
  <form class="form-horizontal" 
   ...
   <div class="form-group">
      ...
      <div class="col-sm-6">
         선택1: <input type="checkbox" name="etc" id="etc" value="선택1">
         선택2: <input type="checkbox" name="etc" id="etc" value="선택2">
         선택3: <input type="checkbox" name="etc" id="etc" value="선택3">
      </div>
    </div>
    <div class="form-group">        
